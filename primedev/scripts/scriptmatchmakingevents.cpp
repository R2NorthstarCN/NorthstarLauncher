				...
				case 2: // matchmaking
					...
					if (!strcmp(info->status.c_str(), "#MATCHMAKING_MATCH_CONNECTING"))
					{
						...
						g_pMasterServerManager->AuthenticateWithServer(
							g_pLocalPlayerUserID, g_pMasterServerManager->m_sOwnClientAuthToken.c_str(), info->serverId.c_str(),
							"");
						...
						g_pCVar->FindVar("serverfilter")->SetValue(conn_info.authToken.c_str());
						Cbuf_AddText(
